    ...
    public partial class InitialDB : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PortalEntity", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Fax = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EmployeeEntity_CompanyEntity_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "CompanyEntity",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EmployeeEntity_PortalEntity_PortalId",
                        column: x => x.PortalId,
                        principalTable: "PortalEntity",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EmployeeEntity_StatusEntity_StatusId",
                        column: x => x.StatusId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeEntity_CompanyId",
                table: "EmployeeEntity",
                column: "CompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_EmployeeEntity_PortalId",
                table: "EmployeeEntity",
                column: "PortalId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeEntity_StatusId",
                table: "EmployeeEntity",
                column: "StatusId");
        }
